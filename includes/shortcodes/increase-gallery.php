		...
		jQuery(document).ready(function($){
			...
			var slick_slider = jQuery('.increase-gallery-slick-slider-<?php echo $rand; ?>')
				.slick({
					...
					//fade: true,
					//cssEase: 'linear',
					slidesToShow: <?php echo $increase_gallery_slides_show; ?>,
					slidesToScroll: <?php echo $increase_gallery_slides_show; ?>,
					accessibility: false,
					arrows: true,
					appendDots: false,
					autoplay: false,
					...
					responsive: [
						{
							breakpoint: 767,
							settings: {
								slidesToShow: <?php echo $increase_gallery_slides_show_mobile; ?>,
								slidesToScroll: <?php echo $increase_gallery_slides_show_mobile; ?>,
							}
						}
					]
				});
